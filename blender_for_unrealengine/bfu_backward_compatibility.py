...
def update_old_variables(print_log: bool = False) -> None:
    ...
    for scene in bpy.data.scenes:
        ...
        bfu_addon_updater.update_data_variable(scene, ["export_static_file_path"], "bfu_export_static_file_path")
        bfu_addon_updater.update_data_variable(scene, ["export_skeletal_file_path"], "bfu_export_skeletal_file_path")
