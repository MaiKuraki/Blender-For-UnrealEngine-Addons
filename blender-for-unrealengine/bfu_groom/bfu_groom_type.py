...
class BFU_Groom(bfu_assets_manager.bfu_asset_manager_type.BFU_BaseAssetClass):
    ...
    def get_package_file_name(self, obj: bpy.types.Object, details: any = None, desired_name: str = "", without_extension: bool = False) -> str:
        ...
        if desired_name:
            return bfu_basics.valid_file_name(scene.bfu_groom_simulation_prefix_export_name+desired_name+fileType)
        return bfu_basics.valid_file_name(scene.bfu_groom_simulation_prefix_export_name+obj.name+fileType)
